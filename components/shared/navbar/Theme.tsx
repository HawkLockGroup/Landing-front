...
function Theme() {
  ...
  return (
    <Menubar className="relative border-none bg-transparent shadow-none">
      <MenubarMenu>
        <MenubarTrigger className="focus:bg-light-900 data-[state=open]:bg-light-900 dark:bg-dark-200 dark:data-[state=open]:bg-dark-200 cursor-pointer">
          {mode === "light" ? (
            <Image
            ...
            <MenubarItem
              ...
              onClick={() => {
                ...
                if (item.value !== "system") {
                  ...
                  // because we take theme from local device
